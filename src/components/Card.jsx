...
function Card({title,read="Read more "}) {
  return (
        
  <><div class="w-[700px] rounded-md border mt-5 flex justify-center items-center ">
  <img
  ...
  />
  <div class="p-4">
    <h1 class="inline-flex items-center text-lg font-semibold text-white">
      {title}  {" "}
      <svg
